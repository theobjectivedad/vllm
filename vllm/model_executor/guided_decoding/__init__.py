...
async def get_guided_decoding_logits_processor(
    ...
    if guided_params.backend_name == 'outlines':
        ...
        from vllm.model_executor.guided_decoding.outlines_decoding import \
            get_outlines_guided_decoding_logits_processor  # noqa
    ...
    if guided_params.backend_name == 'xgrammar':
        from vllm.model_executor.guided_decoding.xgrammar_decoding import \
            get_local_xgrammar_guided_decoding_logits_processor  # noqa
...
def get_local_guided_decoding_logits_processor(
    ...
    if guided_params.backend_name == 'outlines':
        # NOTE: lazy import outlines to avoid https://github.com/vllm-project/vllm/issues/4193
        from vllm.model_executor.guided_decoding.outlines_decoding import \
            get_local_outlines_guided_decoding_logits_processor  # noqa
